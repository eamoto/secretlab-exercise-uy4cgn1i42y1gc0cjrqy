...
class VersionObjectControllerCreateTest extends VersionObjectControllerBaseTest
{
    public function test_create_version_object(): void
    {
        $res = $this->postJson(self::REQ_URI, ["mykey" => "value1"]);
    ...
    {
        $res = $this->postJson(self::REQ_URI, ["mykey" => 111]);
        $res->assertUnprocessable();
    }
    ...
    {
        $res = $this->postJson(self::REQ_URI, ["mykey" => [1, 2, 3, 4]]);
        $res->assertStatus(200);
    }

    public function test_create_version_object_with_non_empty_assoc_array_value(): void
    {
        $res = $this->postJson(self::REQ_URI, ["mykey" => ["key1" => "1", "key2" => "2"]]);
        $res->assertStatus(200);
    }
}
